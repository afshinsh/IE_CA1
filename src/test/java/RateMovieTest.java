...
public class RateMovieTest {
    ...
    public void testUserNotFound() {
        try {
            Storage.Database.AddRateMovie(new Rate("saman@ut.ac.ir", 1, 10));
        }
        catch (Exception e){
    ...
    public void testMovieNotFound() {
        try {
            Storage.Database.AddRateMovie(new Rate("sajjad@ut.ac.ir", 2, 10));
        }
        catch (Exception e){
    ...
    @Test
    public void testRateSuccessful() throws Exception {

        Storage.Database.AddRateMovie(new Rate("sajjad@ut.ac.ir", 1, 10));

        assertEquals(Storage.Database.Movies.get(0).rates.size(), 1);
    }
